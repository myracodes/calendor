...
export const SCHEDULES: Schedule[] = [
  ...
  {
    name: "Bibliothèque",
    weekday: WEEKDAY.MARDI,
    hours: "15h-20h",
    color: LIBRARY,
  },
  {
    name: "Bibliothèque",
    weekday: WEEKDAY.MERCREDI,
    hours: "10h-18h",
    color: LIBRARY,
  },
  {
    name: "Bibliothèque",
    weekday: WEEKDAY.JEUDI,
    hours: "15h-20h",
    color: LIBRARY,
  },
  {
    name: "Bibliothèque",
    weekday: WEEKDAY.VENDREDI,
    hours: "15h-18h",
    color: LIBRARY,
  },
  {
    name: "Bibliothèque",
    weekday: WEEKDAY.SAMEDI,
    hours: "10h-18h",
    color: LIBRARY,
  },
  {
