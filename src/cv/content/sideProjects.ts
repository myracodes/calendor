...
/** Titre de la section. */
export const SIDE_PROJECTS_TITLE: LocalizedText = { bothLanguages: "Side projects" }

export const SIDE_PROJECTS: LocalizedExperience[] = [
  {
    page: 2,
    role: { bothLanguages: "Calendor" },
    employer: { fr: "Projet personnel (2026 - aujourd'hui)", en: "Personal solo project (2026 - present)" },
    context: [
      {
    ...
    missions: [
      ...
      { fr: "Ce CV a été généré par Calendor.", en: "This resume was generated by Calendor" },
    ],
    stack: [
  ...
  },
  {
    ...
    employer: { fr: "Projet personnel (2025 - aujourd'hui)", en: "Personal solo project (2025 - present)" },
    context: [{ fr: "CV en ligne développé en Angular.", en: "Online resume built with Angular." }],
    missions: [
      {
      ...
      { fr: "Composants **PrimeNG**", en: "**PrimeNG** components" },
      { fr: "Tests unitaires **Jasmine / Karma**", en: "**Jasmine / Karma** unit tests" },
    ],
    stack: [
